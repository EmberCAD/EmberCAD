DO NOT INSTALL THIS APPLICATION UNTIL YOU 
HAVE READ AND AGREED TO THE CONDITIONS BELOW

EmberCAD Personal License Agreement
(Single User Product)

THIS SOFTWARE IS FOR ANY PURPOSES - COMMERCIAL OR NONCOMMERCIAL.

This is a legal agreement between the end user and wróblewski multimedia  (the "WMMEDIA"). By opening the sealed disk packet or run downloaded package you are agreeing to be bound by the terms of the agreement. if you do not agree  to the terms of this agreement, do not continue the installation.

EmberCAD Personal SOFTWARE LICENSE
1. GRANT OF LICENSE
WMMEDIA grants the end user the right to use one copy of the enclosed EmberCAD Personal software program (the "SOFTWARE") on a single computer. You may access the software from a hard disk so long as you comply with this agreement. For the purpose "use" means loading the software into RAM or installed onto a hard disk of the computer. Installation on a network for the purpose of distribution of one or more computers shall not constitute "use" for which a separate license is required.

2. COPYRIGHT
The SOFTWARE is owned by WMMEDIA and is protected by Polish copyright laws and international treaty provisions. You must therefore treat the SOFTWARE as you would any other copyrighted material eg: a book. You may however for the sole purpose of backup security make a second copy of the SOFTWARE and keep it either on floppy disks or hard disk. You may not copy any of the written materials accompanying the SOFTWARE. 
