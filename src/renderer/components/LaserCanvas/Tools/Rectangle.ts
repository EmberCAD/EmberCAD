...
import { Counters, E_KIND_RECTANGLE } from '../CanvasElement';
...
export default class Rectangle {
  ...
  onMouseMove(e) {
    ...
    this.rect = new CanvasRectangle(this.paper, this.initRect);
  ...
  onMouseUp() {
    ...
    if (this.rect.element.bounds.width && this.rect.element.bounds.height) {
      ...
      instance.kind = E_KIND_RECTANGLE;
      instance.uname = tr(E_KIND_RECTANGLE) + ' ' + ++Counters.Rectangles;
